...
- **Keshav Das**, *Automated selection of adaptive additive models, application to load consumption forecasting*  
  ...
  Co-supervised with [Margaux Brégère](https://margauxbregere.github.io/) and Amaury Durand.
...
- **Alban Derepas**, *Future evolution of the wind resource and the interest of machine learning methods for statistical wind downscaling*  
  ...
  Co-supervised with Boutheina Oueslati, [Yannig Goude](https://www.imo.universite-paris-saclay.fr/~yannig.goude/about.html), and [Claire Monteleoni](https://www.colorado.edu/faculty/claire-monteleoni/).
